    ...
    <section className="py-20 md:py-10 md:py-xl px-4 md:px-6 bg-slate-50 border-y border-surface-variant/30 overflow-hidden">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="mb-10 md:mb-16 text-center">
          <h2 className="font-h2 font-bold text-2xl md:text-h2 text-on-surface mb-3 md:mb-4 px-2">
            Turlarımızdan Kareler
          </h2>
          <p className="font-body-md text-xs md:text-body-md text-secondary max-w-2xl mx-auto px-4">
            Misafirlerimizin objektifinden unutulmaz anlar ve Anadolu'nun eşsiz güzellikleri.
          </p>
        </div>

        {/* Carousel Alanı */}
        <div className="relative perspective-carousel flex items-center justify-center h-[320px] md:h-[500px]">
          {/* Navigasyon Okları */}
