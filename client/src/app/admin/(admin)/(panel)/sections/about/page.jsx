...
export default function AboutSectionManagementPage() {
    ...
    useEffect(() => {
        const fetchAboutData = async () => {
            try {
                ...
                const backendData = {
                    title: 'Biz Kimiz?',
                    description: 'Yılların getirdiği tecrübe ile konforlu ve güvenli seyahat çözümleri sunuyoruz.'
                };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log("Backend'e giden filtrelenmiş JSON:", updatedFields);

            alert("Hakkımızda bölümü başarıyla güncellendi kanka!");
            setInitialData({
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-slate-500 mt-1">
                                Ana sayfanızdaki hakkımızda alanının üst başlık ve genel tanıtım açıklama metinlerini buradan yönetebilirsiniz.
                            </p>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    {isLoading ? (
                        <div className="p-12 text-center text-slate-500 font-medium">
                            Mevcut hakkımızda bilgileri getiriliyor, lütfen bekleyiniz...
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div>
                                <label htmlFor="title" className="block text-sm font-medium text-slate-700 mb-2">
                                    Hakkımızda Bölüm Başlığı (Title)
                                </label>
                                <input
                                    type="text"
                                    id="title"
                                    ...
                                    placeholder="Örn: Biz Kimiz? / Hikayemiz"
                            ...
                            <div>
                                <label htmlFor="description" className="block text-sm font-medium text-slate-700 mb-2">
                                    Hakkımızda Bölüm Açıklaması (Description)
                                </label>
                                <textarea
                                    id="description"
                                    name="description"
                                    ...
                                    onChange={handleInputChange}
                                    placeholder="Sizi, vizyonunuzu veya işinizi özetleyen genel bir hakkımızda giriş paragrafı..."
