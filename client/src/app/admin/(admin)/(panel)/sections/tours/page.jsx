...
export default function ToursSectionManagementPage() {
    ...
    useEffect(() => {
        const fetchToursData = async () => {
            try {
                ...
                const backendData = {
                    title: 'Unutulmaz Rotalarımızı Keşfedin',
                    description: 'Dünyanın dört bir yanından özenle seçilmiş, her bütçeye uygun macera ve kültür turlarımız.'
                };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert("Turlar bölümü başarıyla güncellendi kanka!");
            setInitialData({
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            <h1 className="text-3xl font-bold text-slate-900">Turlar Bölümü Yönetimi</h1>
                            <p className="text-slate-500 mt-1">
                                Ana sayfanızda tüm turların listelendiği genel alanın üst başlık ve alt açıklama metinlerini buradan güncelleyebilirsiniz.
                            </p>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    {isLoading ? (
                        <div className="p-12 text-center text-slate-500 font-medium">
                            Mevcut turlar bölümü bilgileri getiriliyor, lütfen bekleyiniz...
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Örn: Unutulmaz Rotalarımızı Keşfedin / Güncel Turlarımız"
                            ...
                            <div>
                                <label htmlFor="description" className="block text-sm font-medium text-slate-700 mb-2">
                                    Turlar Bölüm Açıklaması (Description)
                                </label>
                                <textarea
                                    id="description"
                                    name="description"
                                    ...
                                    onChange={handleInputChange}
                                    placeholder="Seyahat severleri turları incelemeye davet eden, genel konsepti anlatan kısa bir alt metin..."
