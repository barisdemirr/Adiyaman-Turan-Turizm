    ...
    <section className="py-10 md:py-xl px-4 md:px-6 bg-secondary text-on-secondary">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="mb-8 md:mb-12 text-center md:text-left">
          <h2 className="font-h2 text-2xl md:text-h2 text-white mb-2 md:mb-4">Favori Turlarınız</h2>
          <p className="font-body-md text-xs md:text-body-md text-secondary-fixed opacity-90">
