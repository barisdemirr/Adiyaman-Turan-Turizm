...
export default function ContactSectionManagementPage() {
        ...
        const fetchContactData = async () => {
            try {
                ...
                const backendData = {
                    ...
                    description: 'Sorularınız, önerileriniz veya tur rezervasyonları için aşağıdaki formu doldurarak bize ulaşabilirsiniz.'
                };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert("İletişim bölümü başarıyla güncellendi kanka!");
            setInitialData({
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-slate-500 mt-1">
                                Ana sayfanızdaki iletişim/mesaj formunun üstünde yer alan başlık ve açıklama metinlerini buradan yönetebilirsiniz.
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Örn: Bizimle İletişime Geçin / Bize Ulaşın"
                            ...
                            <div>
                                <label htmlFor="description" className="block text-sm font-medium text-slate-700 mb-2">
                                    İletişim Bölüm Açıklaması (Description)
                                </label>
                                <textarea
                                    id="description"
                                    name="description"
                                    ...
                                    onChange={handleInputChange}
                                    placeholder="Kullanıcıları mesaj göndermeye teşvik eden veya çalışma saatlerinizi özetleyen kısa alt metni..."
