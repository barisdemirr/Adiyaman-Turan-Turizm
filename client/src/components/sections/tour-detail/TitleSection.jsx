...
const TitleSection = () => {
  return (
    <section className="max-w-[1280px] mx-auto px-4 md:px-6 mt-6 md:mt-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-6">
        <div>
          ...
          {/* Title */}
          <h1 className="font-h1 font-bold text-2xl md:text-h1 text-on-surface leading-tight">
            Nemrut Sunrise &amp; Commagene Kingdom Tour
          </h1>
        </div>
        ...
        <div className="flex items-center gap-5 md:gap-4 border-t md:border-t-0 border-slate-100 pt-3 md:pt-0">
          <button className="flex items-center gap-1.5 md:gap-2 text-[11px] md:text-body-sm font-label-bold text-secondary hover:text-primary transition-colors active:scale-95">
            <span className="material-symbols-outlined text-[18px] md:text-[20px]">share</span> Share
          </button>
          <button className="flex items-center gap-1.5 md:gap-2 text-[11px] md:text-body-sm font-label-bold text-secondary hover:text-primary transition-colors active:scale-95">
            <span className="material-symbols-outlined text-[18px] md:text-[20px]">favorite</span> Wishlist
          </button>
        </div>
      </div>
    </section>
