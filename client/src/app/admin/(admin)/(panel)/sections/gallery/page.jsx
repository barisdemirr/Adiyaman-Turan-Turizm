...
export default function GallerySectionManagementPage() {
    ...
    useEffect(() => {
        const fetchGalleryData = async () => {
            try {
                ...
                const backendData = {
                    title: 'Turlarımızdan Unutulmaz Kareler',
                    description: 'Gezilerimiz esnasında misafirlerimizin kadrajından dökülen en özel ve canlı anılar.'
                };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert("Galeri bölümü başarıyla güncellendi kanka!");
            setInitialData({
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            <h1 className="text-3xl font-bold text-slate-900">Galeri Bölümü Yönetimi</h1>
                            <p className="text-slate-500 mt-1">
                                Ana sayfanızdaki tur fotoğrafları/galeri alanının üst başlık ve alt tanıtım metinlerini buradan yönetebilirsiniz.
                            </p>
                        </div>
                        <div className="flex gap-3">
                            <Link
                                href="/#tur-fotograflari"
                                target="_blank"
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    {isLoading ? (
                        <div className="p-12 text-center text-slate-500 font-medium">
                            Mevcut galeri bilgileri getiriliyor, lütfen bekleyiniz...
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Örn: Turlarımızdan Unutulmaz Kareler / Galeri"
                            ...
                            <div>
                                <label htmlFor="description" className="block text-sm font-medium text-slate-700 mb-2">
                                    Galeri Bölüm Açıklaması (Description)
                                </label>
                                <textarea
                                    id="description"
                                    name="description"
                                    ...
                                    onChange={handleInputChange}
                                    placeholder="Gezilerden çekilen fotoğrafları, anıları özetleyen kısa bir alt giriş cümlesi..."
