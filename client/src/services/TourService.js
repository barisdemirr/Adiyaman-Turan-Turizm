...
async function GetToursNumber() {
  const apiUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/api/tours/toursnumber`;
...
export { GetAllTours, GetTourBySlug, GetToursForReservation, GetAllToursAdmin, CreateTour, UpdateTour, GetTourById, DeleteTour, GetToursNumber };